...
import { EventProducer, IEventProducerConfig } from '../services/EventProducer';
...
export class ApplicationServiceProvider {
  ...
  constructor(appConfig: IApplicationConfig, logger: winston.Logger) {
    ...
    this._serviceContainer = {
      ...
      producer: new EventProducer(this._config.producer, logger),
    };
  }
  ...
  get producer(): EventProducer {
    return this._serviceContainer.producer;
  }
